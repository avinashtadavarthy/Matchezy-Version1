...
public class FragmentDisliked extends Fragment{

    View myView;
    List<MatchedProfiles> lstMatchedProfiles ;

    RecyclerView myrv;
    DislikedRecyclerViewAdapter myAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView =  inflater.inflate(R.layout.fragment_disliked, container, false);
        ...
        myAdapter = new DislikedRecyclerViewAdapter(getActivity().getApplicationContext(),lstMatchedProfiles, getActivity());
    ...
    void getLikedProfiles(int lastItemCount) {
        ...
        AndroidNetworking.post(Utility.getInstance().BASE_URL + "getDislikedProfiles")
                .addBodyParameter(o)
