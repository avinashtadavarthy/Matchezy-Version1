...
public class ForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // actionButton.hide();
        action_button_next2.setType(ActionButton.Type.DEFAULT);
        //actionButton.setSize(65.0f);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            action_button_next2.setButtonColor(Color.parseColor("#EA5251"));
        }
        action_button_next2.setRippleEffectEnabled(true);
        action_button_next2.playShowAnimation();
        action_button_next2.setImageResource(R.drawable.done);
        ...
        edit_countrycode.setShowSoftInputOnFocus(false);
        edit_countrycode.setText("+91");

        edit_countrycode.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
        ...
        edit_countrycode.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void countrycode() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ForgotPassword.this, R.style.SSAlertDialogStyle);
        ...
        alertDialogBuilder.setSingleChoiceItems(items, 96, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                edit_countrycode.setText(code_to_display);
                dialog.dismiss();
            }
        });
